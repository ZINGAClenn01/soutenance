...
"image5": image5form
  ...
  function envoiMaison(event) {
    ...
    axios.post("http://localhost:3001/ajout/maison",nouvelleMaison).then(console.log('posted'))
  }
  ...
  return (
    <div>
      <br />
      <Form>
      <Form.Select onChange={(e)=> setCategorieform(e.target.value)} aria-label="Default select example">
      <option>Selectionner une categorie</option>
      {data.map(item =>(<option value={item.id_categorie}>{item.categorie} </option>))}
          
        </Form.Select>
        <br />
        <Form.Select onChange={(e)=> setQuartierform(e.target.value)} aria-label="Default select example">
        <option>Selectionner le quartier</option>
        {quartiers.map((item) => (<option value={item.id_quartier}>{item.quartier}</option>))}
        ...
        <br />
        <Form.Control onChange={(e)=> setPrixform(e.target.value)} type="text" placeholder="Prix" />
        <br />
        <Form.Group onChange={(e)=> setDescriptionform(e.target.value)} className="mb-3" controlId="exampleForm.ControlTextarea1">
          <Form.Label >Description</Form.Label>
          <Form.Control placeholder="Entre une description" as="textarea" rows={3} />
        </Form.Group>
        <br />
        <Form.Control onChange={(e)=> setChambreform(e.target.value)} type="text" placeholder="Nombre de chambre" />
        <br />
        <Form.Control onChange={(e)=> setDoucheform(e.target.value)} type="text" placeholder="Nombre de douche" />
        <br />
        <Form.Control onChange={(e)=> setSalonform(e.target.value)} type="text" placeholder="Nombre de salon" />
        <br />
        <Form.Control onChange={(e)=> setCoordonneesform(e.target.value)} type="text" placeholder="Coordonnées" />
        <br />
        <Form.Control onChange={(e)=> setTelephoneform(e.target.value)} type="text" placeholder="Téléphone-propriétaire" />
        <br />
        <Form.Group onChange={(e)=> setImage1form(e.target.value)} controlId="formFileSm" className="mb-3">
          <Form.Label>image1</Form.Label>
          <Form.Control type="file" size="sm" />
        </Form.Group>

        <Form.Group onChange={(e)=> setImage2form(e.target.value)} controlId="formFileSm" className="mb-3">
          <Form.Label>image2</Form.Label>
          <Form.Control type="file" size="sm" />
        </Form.Group>

        <Form.Group onChange={(e)=> setImage3form(e.target.value)} controlId="formFileSm" className="mb-3">
          <Form.Label>image3</Form.Label>
          <Form.Control type="file" size="sm" />
        </Form.Group>

        <Form.Group onChange={(e)=> setImage4form(e.target.value)} controlId="formFileSm" className="mb-3">
          <Form.Label>image4</Form.Label>
          <Form.Control type="file" size="sm" />
        </Form.Group>

        <Form.Group onChange={(e)=> setImage5form(e.target.value)} controlId="formFileSm" className="mb-3">

        ...
        <div className="categories">
          ...
          <div className="categories-btn">
            {data.map((item) => (
              <button
                onClick={() => {
                  setidcategorie(item.id_categorie);
              ...
              {maisons.map((item) => (
                <div className="map-card" key={item.id}>
                  ...
                  <div className="row div-quartier-plus">
                    <p>
                      <i class="fa-sharp fa-solid fa-light-emergency"></i> Tout
                      inclus
                    </p>
                    <p>
                      {" "}
                      <i class="fa-solid fa-house-signal"></i> wifi
                    </p>
                    <p>
                      <i class="fa-solid fa-calendar"></i> periode indeterminees
                    </p>
                  </div>
                </div>
              ))}
